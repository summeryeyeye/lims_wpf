...
namespace Lims.WebAPI.Controllers
{
    public class SubItemStandardsController : MyBaseController<SubItemStandardModel, SubItemStandardDto>
    {
        ...
        [HttpGet]
        public async Task<ApiResponse> GetSubItemStandardsBySubItem([FromQuery] SubItemStandardFilterParam param) => await subItemStandardService.QueryAsync(s => s.Name.Equals(param.Name));
