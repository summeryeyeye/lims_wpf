...
namespace Lims.WPF.Resources.UserControls.Export
{
    ...
    {
        const string OpenInInternalViewer = "用DevExpress控件打开";
        const string OpenInExternalViewer = "用默认Excel软件打开";
        const string OpenExportedFile = "打开导出的Excel文件";
        const string OpenExportedFileDescription = "你可以用系统默认的Excel软件打开或以Devexpress控件打开这个Excel表格";
